...
void	*ft_write_space_z(t_struc *form, intmax_t num)
{
	char *string;
	int i;
...
void	*ft_write_space_m(t_struc *form, intmax_t num)
{
	char *string;
	int i;
...
void	*ft_zaibalsya(t_struc *form, intmax_t num)
{
	char *string;
	int i;
...
void	*ft_owidth(t_struc *form, intmax_t num) // write_width
{
	char *string;
	int i;
...
void	*ft_write_other(t_struc *form, intmax_t num)
{
	...
	//	form->ret_nb += write(1, "-9223372036854775808", 20);
	if (form->zero == '0')
		 ft_write_dig(form, num);
	else if(form->space == ' ')
	{
...
t_struc		*work_w_press(t_struc *form, intmax_t num)
{
	...
	if ((form->press == 0 && form->width == 0) || (form->press == 0 && form->width != 0))
		...
		pt_press_1(form, num);
	//else if (form->minus == 1 && form->width > 0)
	//	pt_press_2()



	//else if (form->press == 0 && form->width == 0 )
		//return(form);
	return (form);
}
...
t_struc		*pt_digit(t_struc *form)
{
	...
	//if (num < 0)
		//form->index = 1;
	//if(!form->press && ())
		//ft_bzero(form->format, ft_strlen(form->format));
	if (form->press >= 0)
...
/*
t_struc		fill_index(t_struc *form)
{
	char *str;
